	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="code.php" class="nav-link">Code</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" data-stellar-background-ratio="0.5" style="background-image: url('images/fond.png');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          ...
          <?php
            if (!isset($_SESSION['login'])) {
            echo "<h6 class='footer-heading'>Connectez vous pour accéder a la liste d'achat</h6>";
            }else {
            $requete = $mysqli->prepare("select * from codetable");
            $requete->execute();
            $codes = $requete->fetchAll();
            echo "<table>";
            foreach($codes as $code){
            echo "<tr><td>".$code['Nomducode']." au prix de ".$code['Prix']." euros    ‎‎‎‎‎ ‎ ‎ ‎ ‎ ‎ ‎ </td><td><img src=images/".$code['ImageLien']." alt='ImageCode' width='100' height=70'> </td><td>‎‎‎‎ ‎ ‎ ‎ ‎ ‎ ‎‎‎‎‎ ‎ ‎ ‎ ‎ ‎ ‎<a href='parametre.php?code=".$code['ID']."' class='btn btn-primary px-4 py-3'>Choisir</a></td></tr>";
            }echo "</table>";
          }
